...
sudo docker save -o name-here/wd-nodered-template:v1.00.tar name-here/wd-nodered-template:v1.00 or sudo docker save name-here/wd-nodered-template:v1.00 > wd-nodered-template.tar   
